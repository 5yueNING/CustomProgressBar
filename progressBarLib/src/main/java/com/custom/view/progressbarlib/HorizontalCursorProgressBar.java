package com.custom.view.progressbarlib;
...
/**
 * Created by ${武跃} on 2018/9/6.
 * 一句话简介：--- 横向进度条,上部图标显示进度
 */

public class HorizontalCursorProgressBar extends View {
    ...
    public HorizontalCursorProgressBar(Context context) {
        this(context,null);
    }

    public HorizontalCursorProgressBar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public HorizontalCursorProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void getAttr(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.HorizontalCursorProgressBar);
        progressPaintWidth = typedArray.getDimensionPixelOffset(R.styleable.HorizontalCursorProgressBar_hcpb_progressPaintWidth,  dp2px(4));
        tipHeight =typedArray.getDimensionPixelOffset(R.styleable.HorizontalCursorProgressBar_hcpb_tipHeight,  dp2px(15));
        tipWidth = typedArray.getDimensionPixelOffset(R.styleable.HorizontalCursorProgressBar_hcpb_tipPaintWidth,  dp2px(30));
        tipPaintWidth = typedArray.getDimensionPixelOffset(R.styleable.HorizontalCursorProgressBar_hcpb_tipHeight,  dp2px(1));
        triangleHeight = typedArray.getDimensionPixelOffset(R.styleable.HorizontalCursorProgressBar_hcpb_triangleHeight,  dp2px(3));
        roundRectRadius = typedArray.getDimensionPixelOffset(R.styleable.HorizontalCursorProgressBar_hcpb_roundRectRadius,  dp2px(2));
        textPaintSize =typedArray.getDimensionPixelOffset(R.styleable.HorizontalCursorProgressBar_hcpb_textPaintSize,  sp2px(10)) ;
        progressMarginTop =typedArray.getDimensionPixelOffset(R.styleable.HorizontalCursorProgressBar_hcpb_progressMarginTop,  dp2px(8));
        progressColor = typedArray.getColor(R.styleable.HorizontalCursorProgressBar_hcpb_progressColor, 0xFFf66b12);
        bgColor = typedArray.getColor(R.styleable.HorizontalCursorProgressBar_hcpb_bgColor, 0xFFe1e5e8);
        typedArray.recycle();
    }
     ...
     * @return
     */
    public HorizontalCursorProgressBar setProgressWithAnimation(float progress) {
        mProgress = progress;
        initAnimation();
        return this;
    }
     ...
     * @return
     */
    public HorizontalCursorProgressBar setCurrentProgress(float progress) {
        mProgress = progress;
     ...
     * @return
     */
    public HorizontalCursorProgressBar setProgressListener(ProgressListener listener) {
