...
public class HorizontalTextProgressBar extends View {
    ...
    public HorizontalTextProgressBar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HorizontalTextProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAnimation() {
        ...
        progressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                textString = "下载" + formatNum((int) value) + "%";
     ...
     * @return
     */
    public HorizontalTextProgressBar setProgressListener(ProgressListener listener) {
        progressListener = listener;
        return this;
    }

    public HorizontalTextProgressBar setProgress(float progress) {
        mProgress = progress;
        initAnimation();
        return this;
    }
