...
public class CircleProgressBarView extends View {
    ...
    private void getAttr(AttributeSet attrs) {
        ...
        circleBgStrokeWidth = typedArray.getDimensionPixelOffset(R.styleable.CircleProgressBarView_cpbv_circleBgStrokeWidth, defaultStrokeWidth);
        progressStrokeWidth = typedArray.getDimensionPixelOffset(R.styleable.CircleProgressBarView_cpbv_progressStrokeWidth, defaultStrokeWidth);
        circleBgColor = typedArray.getColor(R.styleable.CircleProgressBarView_cpbv_circleBgColor, circleBgColor);
        progressColor = typedArray.getColor(R.styleable.CircleProgressBarView_cpbv_progressColor, progressColor);
        duration = typedArray.getColor(R.styleable.CircleProgressBarView_cpbv_circleAnimationDuration, duration);
        isDrawCenterProgressText = typedArray.getBoolean(R.styleable.CircleProgressBarView_cpbv_isDrawCenterProgressText, false);
        centerProgressTextColor = typedArray.getColor(R.styleable.CircleProgressBarView_cpbv_centerProgressTextColor, centerProgressTextColor);
        centerProgressTextSize = typedArray.getDimensionPixelOffset(R.styleable.CircleProgressBarView_cpbv_centerProgressTextSize, sp2px(centerProgressTextSize));
        typedArray.recycle();
    }
